        ...
        <section className="admin-section notice-section">
          ...
          <form onSubmit={handleSendNotice} className="admin-form">
            ...
            <div className="input-group">
              ...
              <div className="admin-file-box" onClick={() => document.getElementById('notice-image').click()}>
                <span className="upload-icon">🖼️</span>
                <span className="file-msg">{imageFile ? imageFile.name : "이미지를 선택하거나 여기로 드래그하세요"}</span>
                <input
                  id="notice-image"
                  type="file"
                  accept="image/*"
            ...
            <button type="submit" className="btn-push-submit" disabled={isSending}>
              {isSending ? "🚀 전송 중..." : "전송하기"}
            </button>
          </form>
        </section>
